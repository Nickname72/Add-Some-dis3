...
class MapWeatherApp(QWidget):
    ...
    def _setup_ui(self):
        ...
        # рядок з заголовком і кнопкою панелі
        ...
        # ефект прозорості для правої панелі
    ...
    def _apply_dark_theme_styles(self):
        ...
        self.setStyleSheet(
            ...
            * {{
            ...
            QFrame#glass {{
                background-color: rgba(8,12,16,0.82);      /* темне скло */
                border-radius: 18px;
        ...
        if app:
            ...
            palette.setColor(QtGui.QPalette.Window, QtGui.QColor(8, 12, 16))
            palette.setColor(QtGui.QPalette.WindowText, QtCore.Qt.white)
            palette.setColor(QtGui.QPalette.Base, QtGui.QColor(15, 23, 30))
            palette.setColor(QtGui.QPalette.Text, QtCore.Qt.white)
            palette.setColor(QtGui.QPalette.Button, QtGui.QColor(17, 24, 32))
    ...
    def _apply_light_theme_styles(self):
        ...
        if app:
            palette = QtGui.QPalette()
            palette.setColor(QtGui.QPalette.Window, QtGui.QColor(238, 242, 247))
